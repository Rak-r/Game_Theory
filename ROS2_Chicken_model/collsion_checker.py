...
class ChickenSpeedModulatorNode(Node):
    ...
    def cmd_vel_cb(self, msg):
        ...
        if b_temporalCollision:
            X = int(round(distance_robot_to_closest*3))                                                             # Discretise the points to nearest ints                                                                                                             # NOTE Quantise points to 1 meter boxes
            Y = int(round(distance_ped_to_closest*3))
